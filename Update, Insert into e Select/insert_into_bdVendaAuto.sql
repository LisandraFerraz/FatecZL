INSERT INTO bdvendaauto.`tbcliente`(cpf_cliente, nome_completo, endereco_cliente,telefone_cliente)
	VALUES (12345678912, 'Mariana Duarte Ferreira', 'Rua dos Pesqueiros 93', 11923456789),
		(23456789123, 'Alison Mendes dos Santos', 'Rua Sonho de Luz 853', 11934567891),
        (34567891234, 'Ketlyn Souza Medeiros', 'Rua Presidente Prudente 235', 11945678912),
        (45678912345, 'Luciano Malfoy', 'Rua dos Alfeneiros 4', 11956789123),
        (56789123456, 'Amanda Pereira Silva', 'Rua de Los Santos 48', 11967891234),
        (67891234567, 'Luana Amaral da Silva', 'Rua Madeireiros Santos 211', 11978945612),
        (78912345678, 'Suelen Mauricio Mendes', 'Rua Alencar Silva 239', 11989123456),
        (89123456789, 'Alan Ferreira Cunha', 'Rua Sem Nome 02', 11991234567);
